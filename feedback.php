...
<link href="cssss/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="//fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet">
</head>
<body class="agileits_w3layouts">


 	<a href="http://localhost/ultimate/index.php" id="logo" style="font-size:50px; color:#9b59b6; margin:30px;"><i class="fab fa-gg-circle"></i></a>
    <h1 class="agile_head text-center">Feedback Form</h1>
    <div class="w3layouts_main wrap">
	  <h3>Please help us to serve you better by taking a couple of minutes. </h3>
	    <form action="includes/feedback.inc.php" method="post" class="agile_form">
